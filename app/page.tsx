...
export default function HomePage() {
  ...
  return (
    <>
      {/* Dynamic Main Opening Hero Video Section with Parallax */}
      <section
        ref={heroRef}
        className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-mesh-dark"
      >
        {/* Main Background Video Layer with Parallax Scale & Translate */}
        <motion.div
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <ScrollReveal direction="down" delay={0.1}>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-red-500/30 backdrop-blur-md mb-6 shadow-lg shadow-red-950/30">
          ...
          {/* Tactical Slogan with Word-by-Word Slide Up */}
          <div className="flex justify-center mb-4">
            <TextReveal
              text="PERSEVERE. ENDURE. CONQUER."
              className="text-xl sm:text-2xl font-heading font-bold text-red-500 uppercase tracking-widest justify-center"
              delay={0.25}
            />
          </div>
          ...
          <ScrollReveal delay={0.4}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <MagneticButton onClick={() => setTrialModalOpen(true)}>
                <button
          ...
          {/* Quick Trust Highlights with Staggered Fade */}
          <StaggerContainer className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto pt-8 border-t border-white/10 text-left">
      ...
      {/* Discipline Matrix Showcase with Staggered Reveals */}
      ...
      {/* Facility Bento Grid Teaser with whileHover micro-interactions */}
      <section className="py-20 bg-[#0C0E17] border-y border-white/10 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Bento Grid with Framer Motion whileHover */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <motion.div
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }}
              className="md:col-span-2 relative h-80 rounded-2xl overflow-hidden glass-panel group cursor-pointer border border-white/10"
            >
              <img
              ...
              />
              <div className="absolute inset-0 bg-[#12141D]/70 group-hover:bg-[#12141D]/30 transition-colors duration-500 p-6 flex flex-col justify-end">
            ...
            <motion.div
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }}
              className="relative h-80 rounded-2xl overflow-hidden glass-panel group cursor-pointer border border-white/10"
            >
              <img
